/******************************************************************************
 * @file  loader_sound.h
 * @brief Sound engine dynamic profile — wheel loader class.
 *
 * @details Centralises all behavioural engine-sound parameters for the
 *          wheel loader vehicle class (Volvo L120H family).
 *          These values were migrated from VolvoL120H.h.
 *
...
/// @brief Default sound dynamics for the wheel loader vehicle class.
...
/// @brief Active shaker preset for the wheel loader vehicle class.
