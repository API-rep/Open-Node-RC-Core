...
void input_update(ComBus &bus) {
  ...
  // ==========================================================
    for (uint8_t i = 0; i < InputDigitalMapCount; i++) {
      ...
      // XOR logic : inversé si m.isInverted ou dev.isInverted est vrai
